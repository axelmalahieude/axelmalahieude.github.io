...
Any ski resort needs chair lifts to transport skiers back to the top of runs. For this infrastructure, we need a flat area; using the slope data derived from our digital elevation model, several flat areas were identified. These locations will be also used as the start and end positions for our ski slopes, to ensure skiers do not end up stranded at the bottom of their run.
